      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            <h1>Choose Best Car.</h1>
            <p>We have Lots of super Cars. </p>
            <a href="#" class="btn">Explore Now <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></a> </div>
        </div>
      </div>
    </div>
  </div>
...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      <h2>Choose <span>Best car</span></h2>
      <p> Our company maintain a fleet of vehicles that range from compact cars to larger SUVs and vans, offering customers flexibility in choosing the right vehicle for their needs.</p>
    </div>
    <div class="row"> 
